...
namespace Antastic
{
    ...
    class LeaderboardScreen : MenuScreen
    {
        ...
        public LeaderboardScreen()
        {
            ...
            MenuEntry entry;
            if (GameplayScreen.currentPoints != 0 && GameplayScreen.currentPoints != lastSentScore)
            {
                scoreToSend = true;
                entry = new MenuEntry("");
        ...
        {
            string cypher = Encryption64.Encrypt("Antastic+addNewScore+" + sendName + "+" + GameplayScreen.currentPoints.ToString(), "q{Fe%xR:q{Fe%xR:");
            webRequest = (HttpWebRequest)WebRequest.CreateHttp(new Uri("http://69.67.29.80:8080/Antastic?id=" + cypher, UriKind.Absolute));
        ...
        private static void HTTPCallBack(IAsyncResult asyncResult)
        {
            ...
            try
            {
                ...
                lastSentScore = GameplayScreen.currentPoints;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Fonts.DrawCenteredText(spriteBatch, Fonts.HeaderFont, GameplayScreen.currentPoints.ToString(), scoreLoc, Color.Green);
