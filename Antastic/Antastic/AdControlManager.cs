    ...
    public class AdControlManager
    {
        ...
        public AdControlManager(GameComponentCollection Components, bool testMode = true)
        {
            ...
            if (adType == AdControlType.MSFT)
            {
                if (testMode)
                {
                    AdGameComponent.Initialize(Antastic.sigletonGame, "test_client");
                }
                else
                {
                    AdGameComponent.Initialize(Antastic.sigletonGame, "b227f0eb-af0f-4a63-ba54-b6a4fa0f493c");
                }
        ...
        public void Load()
        {
            ...
            {
                adView = new MMAdView(Antastic.graphics.GraphicsDevice, new Vector2(0, 720), AdPlacement.BannerAdTop);
                adView.Apid = "60242";
            ...
            {
                adDuplex = new AdManager(Antastic.sigletonGame, "9835");
                adDuplex.LoadContent();
                adDuplex.RefreshInterval = 30;
            }
#endif

            defaultAd = Antastic.sigletonGame.Content.Load<Texture2D>("Textures/DefaultAd");
        }
        ...
        public void Draw(GameTime gameTime)
        {
            ...
            if (showAds)
            {
                ...
                SpriteBatch spriteBatch = Antastic.screenManager.SpriteBatch;
